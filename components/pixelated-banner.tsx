...
import { TrigClock } from "@/components/trig-clock";
    ...
    >
      ...
      <div className="absolute inset-0 flex">
        ...
        <div className="flex-1 min-w-0 flex flex-col pt-[2%] pl-[2%] pr-[2%]">
          ...
          <div
            className="hidden lg:block shrink-0 pointer-events-none border-y border-foreground -ml-8 -mr-8 mt-[32px]"
            style={{
              height: "25px",
              ...STRIPE,
            }}
          ...
          <div className="hidden lg:flex flex-col flex-1 min-h-0">
            ...
            <div className="flex items-stretch flex-1 min-h-0">
              ...
              <div
                className="flex-1 -mr-7 flex items-center justify-center select-none border-l border-foreground/20 min-h-full h-full"
                style={{
              ...
              >
                <img
                  src="/more_detail.svg"
                  alt="More Detail"
                  className="w-[240px] max-w-[90%] h-auto opacity-60 -mr-16 dark:invert dark:opacity-50"
                  loading="lazy"
                />
              </div>
            </div>
